...
const mockedGetNextPhase = vi.fn();
const mockedBuildValidationContext = vi.fn();
...
mock.module("../../workflow", () => ({
  ...
  getNextPhase: mockedGetNextPhase,
  buildValidationContext: mockedBuildValidationContext,
}));

const { runPhaseCommand } = await import("../../commands/phase");
